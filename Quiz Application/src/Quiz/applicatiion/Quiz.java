...
public class Quiz extends JFrame implements ActionListener {
    ...
    String[][] questions = new String[10][5]; // this is string Array for storing questions and its options
    String[][] answers = new String[10][2];// this is for answers
    String[][] useranswers = new String[10][1];
    JLabel qno; // we have to declare globally , coz we have to change that dynamically
    JLabel question;
    JRadioButton opt1;
    JRadioButton opt2;
    JRadioButton opt3;
    ...
    Quiz(String name) {
        ...
        this.add(image);
        this.qno = new JLabel();// we dont have to write qno here if we store it will hard coreded it will satble for every qno
        this.qno.setBounds(100, 450, 50, 30);
        this.qno.setFont(new Font("Tahoma", 0, 24));
        this.add(this.qno);
        this.question = new JLabel();//we dont have to write question here if we store it will hard coreded it will satble for every qno
        ...
        this.opt1 = new JRadioButton();// this is a JRadioButton this is round button before of options we have to make for 4 options
        ...
        this.groupoptions = new ButtonGroup();// after this we cant select multiple options we can select only one
        ...
        this.next = new JButton("Next");// these are the three buttons
        ...
        this.submit.setEnabled(false);// Initially this button will be disabled
